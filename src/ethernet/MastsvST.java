    ...
    public String stop() {
        try {
            ...
            while (true) {
                ...
                if (line == null) {
                    break;
                } else if (line.equals(line.contains("[INFO] Final Memory:") || line.equals("[INFO] Jetty not running")) || line.contains("[INFO] Finished at:")) {

                    s = 1;
                    break;
                } else if (line.equals("'mvn' is not recognized as an internal or external command,")) {
                    s = 2;
            ...
            if (s == 1) {
                System.out.println("Processing Started Properly.");
                return "successstop";
            } else {
                System.out.println("Processing Not Started Properly server stop, Please Restart the Server..." + s);
        	...
        	config.MastsvCExcep.handleException(e, "Serstop");
            return "errorforstop";
        }
